...
export AUTO_PAUSE_LAST_ACTIVE_FILE="${AUTO_PAUSE_LAST_ACTIVE_FILE:-${AUTO_PAUSE_WORK_DIR}/last_active.epoch}"
...
export AUTO_PAUSE_KNOCKD_WHITELIST_PATH="${AUTO_PAUSE_KNOCKD_WHITELIST_PATH:-/opt/arkserver/knockd_whitelist.txt}"
export AUTO_PAUSE_KNOCKD_BLACKLIST_PATH="${AUTO_PAUSE_KNOCKD_BLACKLIST_PATH:-/opt/arkserver/knockd_blacklist.txt}"
export AUTO_PAUSE_KNOCKD_GREYLIST_PATH="${AUTO_PAUSE_KNOCKD_GREYLIST_PATH:-/opt/arkserver/knockd_greylist.txt}"
export AUTO_PAUSE_KNOCKD_FILTER_SCRIPT="${AUTO_PAUSE_KNOCKD_FILTER_SCRIPT:-/opt/autopause/knockd_ip_filter.sh}"
export AUTO_PAUSE_KNOCKD_GREYLIST_APPEND_SCRIPT="${AUTO_PAUSE_KNOCKD_GREYLIST_APPEND_SCRIPT:-/opt/autopause/knockd_greylist_append.sh}"
...
AUTO_PAUSE_LAST_ACTIVE_FILE_LEGACY="${AUTO_PAUSE_WORK_DIR}/last_active.ts"
if [[ ! -e "$AUTO_PAUSE_LAST_ACTIVE_FILE" && -f "$AUTO_PAUSE_LAST_ACTIVE_FILE_LEGACY" ]]; then
	mv "$AUTO_PAUSE_LAST_ACTIVE_FILE_LEGACY" "$AUTO_PAUSE_LAST_ACTIVE_FILE" 2>/dev/null || true
fi
